...
useEffect(() => {
 ...
 {/* Cinematic Loader */}
<div
  className={`fixed inset-0 z-[9999] overflow-hidden bg-black transition-transform duration-[1800ms] ease-[cubic-bezier(0.77,0,0.175,1)] ${
...
>
  ...
  <div className="relative z-10 flex items-center justify-center h-full overflow-hidden">
    ...
    {/* VO */}
    <div
      className={`text-7xl md:text-9xl font-black tracking-[12px] text-amber-400 transition-all duration-[1400ms] ease-out ${
        loading
    ...
    {/* RAA */}
    <div
      className={`text-7xl md:text-9xl font-black tracking-[12px] text-white transition-all duration-[1400ms] ease-out ${
        loading
          ? "translate-x-0 opacity-100"
          : "translate-x-[300px] opacity-0"
      }`}
  ...
  {/* Bottom Shine */}
  <div className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-amber-400 to-transparent animate-pulse" />
</div>
<main
...
<section className="relative overflow-hidden bg-[#050505] py-32">
  ...
  {/* Ambient Glow */}
  <div className="absolute left-1/2 top-0 h-[900px] w-[900px] -translate-x-1/2 rounded-full bg-emerald-400/10 blur-[180px]" />
  ...
  <div className="relative z-10 max-w-[2800px] mx-auto px-6 lg:px-10">
    ...
    {/* Product Showcase */}
    <div className="group relative  overflow-hidden rounded-[42px] border border-white/10 bg-[#0B0F0E] shadow-[0_40px_120px_rgba(0,0,0,0.65)]">

      {/* Glow */}
      <div className="absolute left-1/2 top-1/2 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-400/10 blur-[180px]" />

      {/* Main Image */}
      <div className="relative h-[550px] md:h-[700px] lg:h-[850px] overflow-hidden">
        <img
          src="https://res.cloudinary.com/djpfw1goz/image/upload/v1779966895/ChatGPT_Image_May_28_2026_04_44_36_PM_oktii8.png"
        ...
        <Link href="/products/servers">
          <button className="absolute top-[40%] left-[18%] rounded-full border border-white/10 bg-black/70 backdrop-blur-xl px-5 py-3 text-sm font-medium text-[#00E0B8] shadow-[0_0_40px_rgba(0,224,184,0.2)] transition-all duration-300 hover:scale-105 hover:bg-black/90">
            Servers →
          </button>
        </Link>
        ...
        <Link href="/products/cameras">
          <button className="absolute bottom-[16%] left-[24%] rounded-full border border-white/10 bg-black/70 backdrop-blur-xl px-5 py-3 text-sm font-medium text-[#00E0B8] shadow-[0_0_40px_rgba(0,224,184,0.2)] transition-all duration-300 hover:scale-105">
            Camera →
          </button>
        </Link>
        ...
        <Link href="/products/gateway">
          <button className="absolute bottom-[16%] left-[45%] rounded-full border border-white/10 bg-black/70 backdrop-blur-xl px-5 py-3 text-sm font-medium text-[#00E0B8] shadow-[0_0_40px_rgba(0,224,184,0.2)] transition-all duration-300 hover:scale-105">
            Gateway →
          </button>
        </Link>
        ...
        <Link href="/products/smart-lock">
          <button className="absolute top-[58%] right-[39%] rounded-full border border-white/10 bg-black/70 backdrop-blur-xl px-5 py-3 text-sm font-medium text-[#00E0B8] shadow-[0_0_40px_rgba(0,224,184,0.2)] transition-all duration-300 hover:scale-105">
            Smart Lock →
          </button>
        </Link>
        ...
        <Link href="/products/router">
          <button className="absolute bottom-[14%] right-[8%] rounded-full border border-white/10 bg-black/70 backdrop-blur-xl px-5 py-3 text-sm font-medium text-[#00E0B8] shadow-[0_0_40px_rgba(0,224,184,0.2)] transition-all duration-300 hover:scale-105">
            Router →
          </button>
        </Link>
        ...
        <Link href="/products/ip-phone">
          <button className="absolute top-[62%] right-[24%] rounded-full border border-white/10 bg-black/70 backdrop-blur-xl px-5 py-3 text-sm font-medium text-[#00E0B8] shadow-[0_0_40px_rgba(0,224,184,0.2)] transition-all duration-300 hover:scale-105">
            IP Phone →
          </button>
        </Link>
        ...
        <Link href="/products/switch">
          <button className="absolute bottom-[18%] left-[10%] rounded-full border border-white/10 bg-black/70 backdrop-blur-xl px-5 py-3 text-sm font-medium text-[#00E0B8] shadow-[0_0_40px_rgba(0,224,184,0.2)] transition-all duration-300 hover:scale-105">
            Switch →
          </button>
        </Link>
        ...
        <Link href="/products/laptops">
          <button className="absolute top-[18%] left-[45%] rounded-full border border-white/10 bg-white/10 backdrop-blur-xl px-5 py-3 text-sm font-medium text-white shadow-[0_0_40px_rgba(255,255,255,0.08)] transition-all duration-300 hover:scale-105 hover:bg-white/15">
            Laptop →
          </button>
        </Link>
        ...
        <Link href="/products/desktops">
          <button className="absolute top-[28%] right-[18%] rounded-full border border-white/10 bg-white/10 backdrop-blur-xl px-5 py-3 text-sm font-medium text-white shadow-[0_0_40px_rgba(255,255,255,0.08)] transition-all duration-300 hover:scale-105 hover:bg-white/15">
            Desktop →
          </button>
        </Link>
        ...
        <Link href="/products/displays">
          <button className="absolute top-[48%] right-[4%] rounded-full border border-white/10 bg-white/10 backdrop-blur-xl px-5 py-3 text-sm font-medium text-white shadow-[0_0_40px_rgba(255,255,255,0.08)] transition-all duration-300 hover:scale-105 hover:bg-white/15">
            Display →
          </button>
        </Link>
      </div>
